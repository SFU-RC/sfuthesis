...
If you find you have to do so in order to make your thesis compile or to fix a display bug, please let SFU Library know by:

- emailing `theses@sfu.ca`, or
- [filing an issue][newissue] if you have a GitHub account, or
- issuing a pull request if you have a GitHub account and a bugfix.

[download]: https://github.com/SFU-RC/sfuthesis
[editors]: http://en.wikipedia.org/wiki/Comparison_of_TeX_editors
[newissue]: https://github.com/SFU-RC/sfuthesis/issues
